...
Pod::Spec.new do |s|
  s.name             = 'KissPaginate'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KissPaginate.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/KissPaginate'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'WANG Jie' => 'jacques09125715@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/KissPaginate.git', :tag => s.version.to_s }
